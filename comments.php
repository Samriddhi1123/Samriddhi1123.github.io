	...
	<?php if ( have_comments() ) : ?>
		<h2 id="comments-title">
			<?php
				echo get_comments_number().' thought(s) on &ldquo;<span>' . get_the_title() . '</span>&rdquo;' ;
			?>
		</h2>
		...
		<ul class="commentlist">
			<?php
				 ...
				 * to use edenfresh_comment() to format the comments.
				 * If you want to overload this in a child theme then you can
				 * define edenfresh_comment() and that will be used instead.
				 * See edenfresh_comment() in edenfresh/functions.php for more.
				 */
				wp_list_comments(array('callback'=>'edenfresh_comment','avatar_size'=>64, 'reply_text'=>'Reply')); 
			?>
		</ul>
